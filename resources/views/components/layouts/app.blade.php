                                ...
                                <div x-data="{ open: false }" class="relative ml-3">
                                    ...
                                    >
                                        ...
                                        <a
                                            ...
                                            @class(['block px-4 py-2 text-sm text-gray-700', 'bg-gray-100 outline-none' => Request::routeIs('dashboard')])
                                            role="menuitem"
                                            tabindex="-1"
                                        >
                                            Dashboard
                                        ...
                                        <a
                                            ...
                                            @class(['block px-4 py-2 text-sm text-gray-700', 'bg-gray-100 outline-none' => Request::routeIs('settings.*')])
                                            role="menuitem"
                                            tabindex="-1"
                                        >
                                            Settings
                                        ...
                                        <form action="{{ route('logout') }}" method="POST">
                                            ...
                                            <button
                                                type="submit"
                                                class="block w-full cursor-pointer px-4 py-2 text-left text-sm text-gray-700"
                                                role="menuitem"
                                                tabindex="-1"
                                            >
                                                Log out
                    ...
                    <div class="border-t border-gray-700 pt-4 pb-3">
                        ...
                        <div class="mt-3 space-y-1 px-2">
                            <a
                                ...
                                @class([
                                    'block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white',
                                    'bg-gray-900 text-white' => Request::routeIs('settings.*'),
                                ])
                            >
                                Settings
                            </a>
                            ...
                            <form action="{{ route('logout') }}" method="POST">
                                ...
                                <button
                                    type="submit"
                                    class="block w-full cursor-pointer rounded-md px-3 py-2 text-left text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white"
                                >
                                    Log out
                                </button>
                            </form>
